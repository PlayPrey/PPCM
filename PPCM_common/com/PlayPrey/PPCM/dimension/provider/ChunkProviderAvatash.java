package com.PlayPrey.PPCM.dimension.provider;
...
public class ChunkProviderAvatash implements IChunkProvider
{
    /** RNG. */
    private Random rand;
    ...
    public ChunkProviderAvatash(World par1World, long par2, boolean par4)
    {
