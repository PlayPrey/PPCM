...
public class wheatTool_sword extends ItemSword 
{
	{
		this.setCreativeTab(PPCM.tabPPCM);
	this.setUnlocalizedName(Strings.wheatTool_sword);
	}

public wheatTool_sword(int ItemID, EnumToolMaterial material) 
{
