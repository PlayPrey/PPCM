...
public class wheatTool_shovel extends ItemSpade
{
	{
		this.setCreativeTab(PPCM.tabPPCM);
	this.setUnlocalizedName(Strings.wheatTool_shovel);
	}

public wheatTool_shovel(int ItemID, EnumToolMaterial material) 
{
