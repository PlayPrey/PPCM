...
public class wheatTool_pickaxe extends ItemPickaxe
{
	{
		this.setCreativeTab(PPCM.tabPPCM);
	this.setUnlocalizedName(Strings.wheatTool_pickaxe);
	}

public wheatTool_pickaxe(int ItemID, EnumToolMaterial material) 
{
