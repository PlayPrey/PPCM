...
IronFurnace = new IronFurnace(IronFurnaceID, false).setHardness(3.5F).setResistance(2000.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("highSpeedFurnace").setCreativeTab(CreativeTabs.tabBlock);
IronFurnaceActive = new IronFurnace(IronFurnaceActiveID, true).setHardness(3.5F).setResistance(2000.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("highSpeedFurnace");
